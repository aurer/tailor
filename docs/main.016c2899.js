...
var Element = function (_Component) {
  ...
  _createClass(Element, [{
    ...
    value: function render(_ref2) {
      ...
      var sourceCode = children.map(function (vnode) {
        return prettyRender(vnode);
      });
...
function prettyRender(VNode, depth) {
  ...
  depth++;
  var child = "\n" + tabs_before + VNode.children.map(function (c) {
    return prettyRender(c, depth);
    ...
    value: function render() {
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)('input', { 'class': 'Button', type: 'submit', value: 'Form submit' })
        )
      );
    }
  }]);
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'div',
                  { 'class': 'Form-inputs' },
                  (0, _preact.h)('input', { type: 'text', placeholder: 'e.g. John Smith' })
                )
              ),
              (0, _preact.h)(
                'div',
                ...
                (0, _preact.h)(
                  'div',
                  { 'class': 'Form-inputs' },
                  (0, _preact.h)('input', { type: 'email', placeholder: 'e.g. johnsmith@example.com' })
                )
              ),
              (0, _preact.h)('input', { 'class': 'Button Button--primary', type: 'submit' })
            )
          )
        ),
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                'div',
                { 'class': 'Form-inputs' },
                (0, _preact.h)('input', { type: 'password' })
              )
            ),
            (0, _preact.h)(
              'div',
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                'div',
                { 'class': 'Form-inputs Form-inputs--inline' },
                (0, _preact.h)(
                  'label',
                  null,
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'label',
                  null,
                  (0, _preact.h)('input', { type: 'radio', name: 'radio', value: '1' }),
                  'Yes'
                ),
                (0, _preact.h)(
                  'label',
                  null,
                  (0, _preact.h)('input', { type: 'radio', name: 'radio', value: '2' }),
                  'No'
                ),
                (0, _preact.h)(
                  'label',
                  null,
                  (0, _preact.h)('input', { type: 'radio', name: 'radio', value: '3' }),
                  'I dont know'
                )
              )
            )
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            { className: 'CSSGrid' },
            [1, 2, 3, 4].map(function (i) {
              return (0, _preact.h)('div', { className: 'Grid-cell' });
            })
          )
        )
      );
  ...
  _createClass(Options, [{
    ...
    value: function render() {
      return (0, _preact.h)(
        ...
        (0, _preact.h)(_element2.default, { title: 'Widths' }),
        (0, _preact.h)(_element2.default, { title: 'Spacing' }),
        (0, _preact.h)(
          _element2.default,
          { title: 'Primary colors', source: 'false' },
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--primary-lighter' },
            '$color-primary-lighter'
          ),
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--primary-light' },
            '$color-primary-light'
          ),
          (0, _preact.h)(
            'div',
          ...
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--primary-dark' },
            '$color-primary-dark'
          ),
          (0, _preact.h)(
            'div',
        ...
        (0, _preact.h)(
          _element2.default,
          { title: 'Secondary colors', source: 'false' },
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--secondary-lighter' },
            '$color-secondary-lighter'
          ),
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--secondary-light' },
            '$color-secondary-light'
          ),
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--secondary' },
            '$color-secondary'
          ),
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--secondary-dark' },
        ...
        (0, _preact.h)(
          _element2.default,
          { title: 'Neutral colors', source: 'false' },
          (0, _preact.h)(
            'div',
          ...
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--neutral-lighter' },
            '$color-neutral-lighter'
          ),
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--neutral-light' },
            '$color-neutral-light'
          ),
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--neutral' },
            '$color-neutral'
          ),
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--neutral-dark' },
            '$color-neutral-dark'
          ),
          (0, _preact.h)(
            'div',
        ...
        (0, _preact.h)(
          _element2.default,
          { title: 'Message colors', source: 'false' },
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--message-info' },
            '$color-message-info'
          ),
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--message-success' },
            '$color-message-success'
          ),
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--message-warning' },
            '$color-message-warning'
          ),
          (0, _preact.h)(
            'div',
            { 'class': 'Color Color--message-error' },
            '$color-message-errorer'
          )
        )
      );
    }
...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.state = {
      elements: ['Buttons', 'Forms', 'Colors', 'Grid', 'Options']
    };
    return _this;
  }
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(_options2.default, { path: 'options' })
          )
        )
      );
    }
